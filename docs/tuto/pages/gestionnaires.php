...
<p>Les gestionnaires (ou <span class="code">Manager</span>) sont les classes responsables d'exécuter les requêtes à votre base de données. C'est le coeur de votre "modèle".</p>
<p>Concrètement, chaque fois que vous souhaitez faire une requête à la base de données, vous devriez venir y créer une fonction qui s'en chargera, sauf si elle existe déjà dans le gestionnaire de base du framework.</p>
...
<p>Par exemple, pour créer un gestionnaire relié à une table de commentaires nommées <span class="code">comments</span> : </p>
